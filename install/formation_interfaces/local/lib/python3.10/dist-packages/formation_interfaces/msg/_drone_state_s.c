...
bool formation_interfaces__msg__drone_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("formation_interfaces.msg._drone_state.DroneState", full_classname_dest, 48) == 0);
  }
  formation_interfaces__msg__DroneState * ros_message = _ros_message;
  {  // timestamp
...
PyObject * formation_interfaces__msg__drone_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("formation_interfaces.msg._drone_state");
