...
static const _DroneState_type_support_symbol_names_t _DroneState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, formation_interfaces, msg, DroneState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, formation_interfaces, msg, DroneState)),
  }
};
...
{
  return &::formation_interfaces::msg::rosidl_typesupport_cpp::DroneState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, formation_interfaces, msg, DroneState)() {
  return get_message_type_support_handle<formation_interfaces::msg::DroneState>();
}
