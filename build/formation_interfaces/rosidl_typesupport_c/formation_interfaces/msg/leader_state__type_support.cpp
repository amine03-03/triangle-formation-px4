...
static const _LeaderState_type_support_symbol_names_t _LeaderState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, formation_interfaces, msg, LeaderState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, formation_interfaces, msg, LeaderState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, formation_interfaces, msg, LeaderState)() {
  return &::formation_interfaces::msg::rosidl_typesupport_c::LeaderState_message_type_support_handle;
}
