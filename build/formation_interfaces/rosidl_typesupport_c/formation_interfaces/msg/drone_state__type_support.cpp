...
static const _DroneState_type_support_symbol_names_t _DroneState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, formation_interfaces, msg, DroneState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, formation_interfaces, msg, DroneState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, formation_interfaces, msg, DroneState)() {
  return &::formation_interfaces::msg::rosidl_typesupport_c::DroneState_message_type_support_handle;
}
